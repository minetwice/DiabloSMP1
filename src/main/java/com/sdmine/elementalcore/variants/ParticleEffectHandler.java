...
public class ParticleEffectHandler {
    public void emitParticles(Player player, WeaponVariant variant) {
        ...
        switch (type) {
            ...
            case "GREEN_SPARK_CRACK" -> { loc.getWorld().spawnParticle(Particle.VILLAGER_HAPPY, loc, 3, 0.3, 0.5, 0.3, 0); loc.getWorld().spawnParticle(Particle.BLOCK, loc, 2, 0.3, 0.5, 0.3, 0, org.bukkit.Material.DIRT.createBlockData()); }
