...
for id_name, rgb in STONES:
  ...
  "textures": {{
    ...
    hud.save(os.path.join(TEXTURES_FONT_DIR, f"diablo_{id_name}.png"))

# Generate static HUD icons
create_hud_icon((0,0,0), "none").save(os.path.join(TEXTURES_FONT_DIR, "diablo_none.png"))
create_hud_icon((0,0,0), "ready").save(os.path.join(TEXTURES_FONT_DIR, "diablo_ready.png"))
